...
<body>
	...
	<div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
		...
		<div class="row">
			<div class="col-lg-12">
				<h1 class="page-header">Budaya</h1>
			</div>
		</div><!--/.row-->
		<div class="row">
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<a href="tambah_budaya.php"><button type="button" class="pull-left btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Tambah</button></a>
					</div>
						...
						<div class="canvas-wrapper">
							<div class="table-responsive">
								<table id="ngoding" class="table table-striped table-bordered">
							        ...
							        <tbody>
							        	<?php
					                        $sql = mysqli_query($con, "SELECT * from budaya");
					                        while ($data = mysqli_fetch_array($sql)){
					                    ?>
							            <tr>
							                <td><?php echo $data['nama'];?></td>
                                            <td><?php echo $data['deskripsi'];?></td>
                                            <td><img src="image/budaya/<?php echo $data['gambar']; ?>" border="0" style="height: 150px;width: 200px"/></td>
                                            <td><a href="edit_budaya.php?id_budaya=<?=$data['id_budaya']?>"><button class="btn btn-warning"><span class="glyphicon glyphicon-pencil"></span> Edit</button></a>
                        					<a href="delete_budaya.php?id_budaya=<?=$data['id_budaya']?>"onclick="return confirm('Yakin akan dihapus ?');"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Hapus</button></a></td>
							            </tr>
							            <?php
					                    	}
					                    ?>
