			...
			<div class="col-md-12">
				<div class="panel panel-default">
					<div class="panel-heading">
						<a href="tambah_user.php"><button type="button" class="pull-left btn btn-primary"><span class="glyphicon glyphicon-plus"></span> Tambah</button></a>
					</div>
								...
								<table id="ngoding" class="table table-striped table-bordered">
							        ...
							        <tbody>
							            ...
							            <tr>
                                            ...
                                            <td><a href="edit_user.php?id_user=<?=$data['id_user']?>"><button class="btn btn-warning"><span class="glyphicon glyphicon-pencil"></span> Edit</button></a>
                        					<a href="delete_user.php?id_user=<?=$data['id_user']?>"onclick="return confirm('Yakin akan dihapus ?');"><button class="btn btn-danger"><span class="glyphicon glyphicon-trash"></span> Hapus</button></a></td>
							            </tr>
							            <?php
					                    	}
					                    ?>
