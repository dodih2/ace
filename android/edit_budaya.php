...
<body>
    ...
    <div class="col-sm-9 col-sm-offset-3 col-lg-10 col-lg-offset-2 main">
        ...
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">Edit Budaya</h1>
            </div>
        </div><!--/.row-->
        <div class="row">
            <div class="col-md-12">
                <div class="panel panel-default">
                    <div class="panel-body">
                        ...
                        <?php
                            include "koneksi.php";
                            $data_edit = mysqli_query($con,"SELECT * FROM budaya WHERE id_budaya='".$_GET['id_budaya']."'");
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row" style="margin-top: 15px">
                                ...
                                <div class="col-md-10">
                                    <textarea rows="7" cols="70" name="deskripsi"><?php echo $row['deskripsi'] ?></textarea>
                                    <!-- <input type="text" class="text" name="deskripsi" value="<?php echo $row['deskripsi'] ?>"></input> -->
                                </div>
                            </div>
                            <div class="row" style="margin-top: 15px">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-10">
                                    <input type="text" class="text" name="gambar" value="<?php echo $row['gambar'] ?>"></input>
                                </div>
                            </div>
                            <div class="row" style="margin-top: 15px">
                                <div class="col-md-12">
                                    <a onclick="goBack()" class="btn btn-danger">Batal</a>
                                    <input type="submit" value="Edit" name="edit" class="btn btn-info"></input>
                                </div>
                            </div>
                        </form>
                        <?php
                          if(isset($_POST['edit'])){
                                 $update = mysqli_query($con,"UPDATE budaya SET nama='".$_POST['nama']."',deskripsi='".$_POST['deskripsi']."',gambar='".$_POST['gambar']."' WHERE id_budaya='".$_GET['id_budaya']."'");
                                 if($update){
                                       ...
                                       echo "<meta http-equiv='refresh' content='1 url=edit_budaya.php'>";
                                 }
                          }
                        ?>
                        </div>
