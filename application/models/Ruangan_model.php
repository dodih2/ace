...
class Ruangan_model extends CI_Model{
  ...
  function get_all_ruangan(){ //ambil data mahasiswa dari tabel dari tabel user_mahasiswa
    ...
    $this->datatables->add_column('view','<a href="javascript:void(0);" class="edit_record btn btn-info btn-xs" data-id_ruangan="$1" data-jurusan="$3" data-nama_ruangan="$2">Edit</a> <a href="javascript:void(0);" class="hapus_record btn btn-danger btn-xs" data-id_ruangan="$1">Hapus</a>','id_ruangan, nama_ruangan, id_jurusan, nama_jurusan');
