...
class Jadwal_model extends CI_Model{
  ...
  function get_all_jadwal(){ //ambil data mahasiswa dari tabel dari tabel user_mahasiswa
    $this->datatables->select('id_jadwal, nama_hari, kode_matkul, kelas_id, id_ruangan, id_jurusan, semester, nik, jam_mulai, jam_selesai, jam_istirahat, kelas_nama, nama_ruangan, nama_jurusan');
    ...
    $this->datatables->add_column('view','<a href="javascript:void(0);" class="edit_record btn btn-info btn-xs" data-id_jadwal="$1" data-nama_hari="$2" data-kode_matkul="$3" data-kelas="$4" data-ruangan="$5" data-jurusan="$6" data-semester="$7" data-nik="$8" data-jamm="$9" data-jams="$10" data-jami="$11">Edit</a> <a href="javascript:void(0);" class="hapus_record btn btn-danger btn-xs" data-id_jadwal="$1">Hapus</a>','id_jadwal, nama_hari, kode_matkul, kelas_id, id_ruangan, id_jurusan, semester, nik, jam_mulai, jam_selesai, jam_istirahat, kelas_nama, nama_ruangan, nama_jurusan');
