...
class Jadwal_model extends CI_Model{
  ...
  function get_all_jadwal(){ //ambil data mahasiswa dari tabel dari tabel user_mahasiswa
    $this->datatables->select('id_jadwal, nama_hari, kode_matkul, kelas_id, id_ruangan, id_jurusan, semester, nik, jam_mulai, jam_selesai, kelas_nama, nama_ruangan, nama_jurusan');
