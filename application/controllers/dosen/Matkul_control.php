...
class Matkul_control extends CI_Controller{
  ...
  public function __construct()
  {
    ...
    $this->load->model('matkul_dosen_model'); // load model matkul_dosen_model
  }

  function index()
  {
    $x['mata_kuliah'] = $this->matkul_dosen_model->get_matkul();
    $x['jurusan'] = $this->matkul_dosen_model->get_jurusan();
    $this->load->view('dosen/konten/v_matkul_data', $x);
  }

  function get_matkul_json(){ //data data produk by JSON object
    header('Content-Type: application/json');
    echo $this->matkul_dosen_model->get_all_matkul();
  }
