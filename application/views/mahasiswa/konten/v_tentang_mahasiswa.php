							...
							<div class="col-xs-12">
								...
								<a href="<?php echo base_url('index.php/mahasiswa/body_control') ?>">
									<button class="btn btn-danger btn-sm">
																...
																<div class="center">
								<h2> <strong>Aplikasi Absensi Mahasiswa merupakan aplikasi yang bertujuan untuk memudahkan Dosen dan Mahasiswa dalam melakukan kegiatan Absensi</strong> </h2>
								<br>
								<br>
								<br>
