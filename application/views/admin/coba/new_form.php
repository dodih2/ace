                ...
                <?php if ($this->session->flashdata('success')): ?>
        				...
        				<div class="card mb-3">
        					<div class="card-header">
        						<a href="<?php echo site_url('admin/jadwal_control/') ?>"><i class="fas fa-arrow-left"></i> Back</a>
        					</div>
        					<div class="card-body">

        						<form action="<?php base_url('admin/jadwal_control/add') ?>" method="post" enctype="multipart/form-data" >
        							<div class="form-group">
        								<label for="nama_hari">Nama Hari*</label>
        								<input class="form-control <?php echo form_error('nama_hari') ? 'is-invalid':'' ?>"
        								 type="text" name="nama_hari" placeholder="Nama Hari" />
        							...
        							<div class="form-group">
        								...
        								<textarea class="form-control <?php echo form_error('semester') ? 'is-invalid':'' ?>"
        								 name="semester" placeholder="Semester"></textarea>
        								<div class="invalid-feedback">
