                    ...
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-group">
                            <input type="number" name="data_id" class="form-control" placeholder="Kode Kelas" required>
                          </div>
                  ...
                  <div class="modal fade" id="ModalUpdate" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        <div class="modal-header">
                          <button type="button" class="close" data-dismiss="modal" aria-label="Close"> <span aria-hidden="true">&times;</span> </button>
                          <h4 class="modal-title" id="myModalLabel">Update Kelas</h4>
                        </div>
                        <div class="modal-body">
													<div class="form-group">
														<select class="form-control" name="jurusan" placeholder="Jurusan" required>
                          ...
                          <div class="form-group">
                            <input type="number" name="data_id" class="form-control" placeholder="Kode Kelas" readonly required>
                          </div>
                  ...
                  <div class="modal fade" id="ModalHapus" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <input type="hidden" name="data_id" class="form-control" placeholder="Kelas" required>
                          <strong>Anda yakin mau menghapus Kelas ini?</strong>
                        </div>
                        <div class="modal-footer">
                          <button type="button" class="btn btn-default" data-dismiss="modal">Tutup</button>
      ...
      var table = $("#mytable").dataTable({
        initComplete: function(){
          ...
          $('#mytable').on('click','.edit_record',function(){
            var id=$(this).data('kelas_id');
						var jurusan=$(this).data('jurusan');
            var nama=$(this).data('kelas_nama');
