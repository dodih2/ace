	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Mahasiswa TI</li>
						</ul><!-- /.breadcrumb -->
					</div>
                ...
                <!-- Modal Add Produk -->
                <form id="add-row-form" action="<?php echo base_url().'index.php/admin/list_mahasiswa_control/simpanti' ?>" method="post">
                ...
                <!-- Modal Update Produk -->
                <form id="add-row-form" action="<?php echo base_url().'index.php/admin/list_mahasiswa_control/updateti' ?>" method="post">
                ...
                <!-- Modal Hapus Produk -->
                <form id="add-row-form" action="<?php echo base_url().'index.php/admin/list_mahasiswa_control/deleteti' ?>" method="post">
