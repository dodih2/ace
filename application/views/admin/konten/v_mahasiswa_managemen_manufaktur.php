	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
                ...
                <!-- Modal Add Produk -->
                <form id="add-row-form" action="<?php echo base_url().'index.php/admin/list_mahasiswa_control/simpanmanufaktur' ?>" method="post">
                ...
                <!-- Modal Update Produk -->
                <form id="add-row-form" action="<?php echo base_url().'index.php/admin/list_mahasiswa_control/updatemanufaktur' ?>" method="post">
                ...
                <!-- Modal Hapus Produk -->
                <form id="add-row-form" action="<?php echo base_url().'index.php/admin/list_mahasiswa_control/deletemanufaktur' ?>" method="post">
      ...
      var table = $("#mytable").dataTable({
        initComplete: function(){
          ...
          $('#mytable_filter input')
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?php echo base_url().'index.php/admin/list_mahasiswa_control/get_mahasiswa_manufaktur_json' ?>", "type": "POST"},
                  columns: [
                    {"data": "nim"},
                    {"data": "nama"},
                    {"data": "jenis_kelamin"},
