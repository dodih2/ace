	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Mahasiswa RPL</li>
						</ul><!-- /.breadcrumb -->
					</div>
                ...
                <!-- Modal Add Produk -->
                <form id="add-row-form" action="<?php echo base_url().'index.php/admin/list_mahasiswa_control/simpanrpl' ?>" method="post">
                ...
                <!-- Modal Update Produk -->
                <form id="add-row-form" action="<?php echo base_url().'index.php/admin/list_mahasiswa_control/updaterpl' ?>" method="post">
                ...
                <!-- Modal Hapus Produk -->
                <form id="add-row-form" action="<?php echo base_url().'index.php/admin/list_mahasiswa_control/deleterpl' ?>" method="post">
      ...
      var table = $("#mytable").dataTable({
        initComplete: function(){
          ...
          $('#mytable_filter input')
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?php echo base_url().'index.php/admin/list_mahasiswa_control/get_mahasiswa_rpl_json' ?>", "type": "POST"},
                  columns: [
                    {"data": "nim"},
                    {"data": "nama"},
                    {"data": "jenis_kelamin"},
