															...
															<div class="row">
																<div class="col-xs-12 col-sm-2">
																	<div class="text-center">
																		<img height="150" class="thumbnail inline no-margin-bottom" alt="Domain Owner's Avatar" src="<?php echo base_url('assets/template/back') ?>/images/avatars/profile-pic.jpg" />
																		<br />
