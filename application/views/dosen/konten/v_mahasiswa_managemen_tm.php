				...
				<div class="main-content-inner">
					<div class="breadcrumbs ace-save-state" id="breadcrumbs">
						<ul class="breadcrumb">
							...
							<li class="active">Mahasiswa TM</li>
						</ul><!-- /.breadcrumb -->
					</div>
					...
					<div class="page-content">
						...
						<div class="row">
								<!-- PAGE CONTENT BEGINS -->
                <div class="col-xs-12">
<h3><strong>Mahasiswa D3 Teknik Mesin	 </strong></h3>
      ...
      var table = $("#mytable").dataTable({
        initComplete: function(){
          ...
          $('#mytable_filter input')
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?php echo base_url().'index.php/dosen/list_mahasiswa_control/get_mahasiswa_tm_json' ?>", "type": "POST"},
                  columns: [
                    {"data": "nim"},
                    {"data": "nama"},
                    {"data": "jenis_kelamin"},
