	...
	<body class="no-skin">
		...
		<div class="main-container ace-save-state" id="main-container">
			...
			<div class="main-content">
                ...
                <!-- Modal Add Produk -->
                <form id="add-row-form" action="<?php echo base_url().'index.php/dosen/list_mahasiswa_control/simpan' ?>" method="post">
                ...
                <!-- Modal Update Produk -->
                <form id="add-row-form" action="<?php echo base_url().'index.php/dosen/list_mahasiswa_control/update' ?>" method="post">
                ...
                <!-- Modal Hapus Produk -->
                <form id="add-row-form" action="<?php echo base_url().'index.php/dosen/list_mahasiswa_control/delete' ?>" method="post">
