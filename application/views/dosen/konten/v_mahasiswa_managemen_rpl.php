				...
				<div class="main-content-inner">
					...
					<div class="page-content">
						...
						<div class="row">
								<!-- PAGE CONTENT BEGINS -->
                <div class="col-xs-12">
	<h3><strong>Mahasiswa D4 Teknik Rekayasa Perangkat Lunak</strong></h3>
      ...
      var table = $("#mytable").dataTable({
        initComplete: function(){
          ...
          $('#mytable_filter input')
            ...
            processing: true,
            serverSide: true,
            ajax: {"url": "<?php echo base_url().'index.php/dosen/list_mahasiswa_control/get_mahasiswa_rpl_json' ?>", "type": "POST"},
                  columns: [
                    {"data": "nim"},
                    {"data": "nama"},
                    {"data": "jenis_kelamin"},
