...
<html lang="en">
	<head>
		...
		<link rel="stylesheet" href="<?php echo base_url('assets/template/back') ?>/css/jquery-ui.custom.min.css" />
		<link rel="stylesheet" href="<?php echo base_url('assets/template/back') ?>/css/chosen.min.css" />
		<link rel="stylesheet" href="<?php echo base_url('assets/template/back') ?>/css/bootstrap-datepicker3.min.css" />
		<link rel="stylesheet" href="<?php echo base_url('assets/template/back') ?>/css/bootstrap-timepicker.min.css" />
		<link rel="stylesheet" href="<?php echo base_url('assets/template/back') ?>/css/daterangepicker.min.css" />
		<link rel="stylesheet" href="<?php echo base_url('assets/template/back') ?>/css/bootstrap-datetimepicker.min.css" />
		<link rel="stylesheet" href="<?php echo base_url('assets/template/back') ?>/css/bootstrap-colorpicker.min.css" />
									...
									<ul class="dropdown-menu dropdown-navbar">
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo base_url('assets/template/back') ?>/images/avatars/avatar.png" class="msg-photo" alt="Alex's Avatar" />
												<span class="msg-body">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo base_url('assets/template/back') ?>/images/avatars/avatar3.png" class="msg-photo" alt="Susan's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo base_url('assets/template/back') ?>/images/avatars/avatar4.png" class="msg-photo" alt="Bob's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo base_url('assets/template/back') ?>/images/avatars/avatar2.png" class="msg-photo" alt="Kate's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
										...
										<li>
											<a href="#" class="clearfix">
												<img src="<?php echo base_url('assets/template/back') ?>/images/avatars/avatar5.png" class="msg-photo" alt="Fred's Avatar" />
												<span class="msg-body">
													<span class="msg-title">
...
<![endif]-->
		...
		<script src="<?php echo base_url('assets/template/back') ?>/js/chosen.jquery.min.js"></script>
		<script src="<?php echo base_url('assets/template/back') ?>/js/spinbox.min.js"></script>
		<script src="<?php echo base_url('assets/template/back') ?>/js/bootstrap-datepicker.min.js"></script>
		<script src="<?php echo base_url('assets/template/back') ?>/js/bootstrap-timepicker.min.js"></script>
		<script src="<?php echo base_url('assets/template/back') ?>/js/moment.min.js"></script>
		<script src="<?php echo base_url('assets/template/back') ?>/js/daterangepicker.min.js"></script>
		<script src="<?php echo base_url('assets/template/back') ?>/js/bootstrap-datetimepicker.min.js"></script>
		<script src="<?php echo base_url('assets/template/back') ?>/js/bootstrap-colorpicker.min.js"></script>
		<script src="<?php echo base_url('assets/template/back') ?>/js/jquery.knob.min.js"></script>
		<script src="<?php echo base_url('assets/template/back') ?>/js/autosize.min.js"></script>
		<script src="<?php echo base_url('assets/template/back') ?>/js/jquery.inputlimiter.min.js"></script>
		<script src="<?php echo base_url('assets/template/back') ?>/js/jquery.maskedinput.min.js"></script>
		<script src="<?php echo base_url('assets/template/back') ?>/js/bootstrap-tag.min.js"></script>
